...
with st.sidebar:
    ...
    with st.expander("🏠 CHARGES FIXES", expanded=False):
        ...
        a_vie = st.number_input("Assurance Vie (€)", value=50) # LA VOICI
...
with tab_admin:
    st.subheader("🛡️ Archives & Sauvegarde")
